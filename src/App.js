...
<nav className="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center" id="myNavbar">
  {/* <!-- Avatar image in top left corner --> */}
  <img src="https://i.imgur.com/LpsG1Zq.jpg" alt="smoke" style={{ width: '100%' }} />
...
<div className="w3-padding-large" id="main">
  ...
  <header className="w3-container w3-padding-32 w3-center w3-black" id="home">
    ...
    <img src="https://i.imgur.com/6Dd7vZa.jpg" alt="boy" className="w3-image" id="HeadShot" style={{ width: '400px' }} />
  </header>

  {/* <!-- About Section --> */}
  <div className="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
    <h2 className="w3-text-light-grey" style={{textShadow: "1px -2px rgb(100, 11, 11)", fontWeight: "800"}}>About Me</h2>
    <hr style={{ width: '200px' }} className="w3-opacity" />
    
    <p style={{fontSize: "20px"}}>
      Hello There! Thanks for checking out my Portfolio! Three years of high school robotics opened a new perspective
      to understanding how machines work and how to comunicate to them. This new perspective developed a fascination 
      inside me to learn how sites and applications I used daily worked and to create my own and delve into the Programming world more!
      Graduating out of high school, I looked to the amazing city of San Francisco to grow and expand my knowledge on the technical world!
      Thus, my experiences with General Assembly began. In twelve short weeks of GA's Software Engineering Immersive(SEI), I've tapped on a 
      newly found desire to learn to code anything and everything I can! As a graduate from GA's SEI, I look to expand my base of knowledge
      even more through collaborative work with other developers and through vast amounts of technical problems!
    </p>
    
  </div>
  <div className="w3-padding-64 w3-content" id="skills">
    <h2 className="w3-text-light-grey" style={{textShadow: "1px -2px rgb(100, 11, 11)", fontWeight: "800"}}>My Skills</h2>
  ...
  <div className="w3-padding-64 w3-content" id="projects">
    <h2 className="w3-text-light-grey" style={{textShadow: "1px -2px rgb(100, 11, 11)", fontWeight: "800"}}>My Projects</h2>
    <hr style={{ width: '200px' }} className="w3-opacity" />
    ...
    <div className="w3-row-padding" style={{ margin: '0 -16px' }}>
      <div className="w3-half">
        <div className="project-card">
          ...
          <img src="https://i.imgur.com/NeCJEHh.png" alt='WeStream' className="project-img" />
          <p className="project-description">For my Software Engineering immersive(SEI) final project, I built WeStream!</p>
          <p className="project-description">WeStream utilizes the power of React, while also implementing back-end services, making it a Fullstack App!</p>
          <div className="project-link-ctnr">
            <a target='_blank' rel='noopener noreferrer' href='https://westream-tyler-youtube-clone.herokuapp.com/'>
              <i className="fa fa-external-link w3-hover-opacity w3-xxlarge" />
            </a>
            <a target='_blank' rel="noopener noreferrer" href='https://github.com/tvilla0000/WeStream'>
      ...
      <div className="w3-half">
        <div className="project-card">
          ...
          <img src="https://i.imgur.com/yAn25C6.png" alt='Tasty' className="project-img" />
          <p className="project-description">The development of Tasty was started after the introduction of Python in the Immersive!</p>
          <p className="project-description">Tasty implemented Python and Django as a framework to create a application alike to yelp!</p>
          <div className="project-link-ctnr">
            <a target='_blank' rel='noopener noreferrer' href='http://menunav.herokuapp.com/'>
              <i className="fa fa-external-link w3-hover-opacity w3-xxlarge" />
            </a>
            <a target='_blank' rel="noopener noreferrer" href='https://github.com/tvilla0000/Tasty'>
              <i className="fa fa-github w3-hover-opacity w3-xxlarge" />
            </a>
          </div>
        </div>
  ...
  <div className="w3-padding-64 w3-content w3-text-grey" id="contact">
    <h2 className="w3-text-light-grey" style={{textShadow: "1px -2px rgb(100, 11, 11)", fontWeight: "800"}}>Contact Me</h2>
    <hr style={{ width: '200px' }} className="w3-opacity" />

    <div className="w3-section">
      <p><i className="fa fa-map-marker fa-fw w3-text-white w3-xxlarge w3-margin-right"></i> San Francisco, US</p>
      <p><i className="fa fa-phone fa-fw w3-text-white w3-xxlarge w3-margin-right"></i> Phone: &nbsp; 925-350-2272</p>
      <p><i className="fa fa-envelope fa-fw w3-text-white w3-xxlarge w3-margin-right"> </i> Email: &nbsp; tvilla0000@gmail.com</p>
    </div><br/>
    ...
    <form onSubmit={this.handleSubmit}>
      ...
      <p>
        <button className="w3-button w3-light-grey w3-padding-large" type="submit" id="submit-btn">
  ...
  <footer className="w3-content w3-padding-32 w3-text-grey w3-xlarge">
    <div className='w3-col w3-margin-bottom footer-link-ctnr' id="network-links">
      <div className='w3-third w3-center'>
        <a target='_blank' rel="noopener noreferrer" href='https://github.com/tvilla0000'>
          <i className="fa fa-github w3-hover-opacity w3-jumbo"/>
        </a>
      </div>
      <div className='w3-third w3-center'>
        <a target='_blank' rel="noopener noreferrer" href='https://www.linkedin.com/in/tyler-villa-61ba94190/'>
          <i className="fa fa-linkedin w3-hover-opacity w3-jumbo" />
        </a>
      </div>
      <div className='w3-third w3-center'>
        <a target='_blank' rel="noopener noreferrer" href='https://profiles.generalassemb.ly/profiles/tvilla01'>

          <img src="https://ga-core.s3.amazonaws.com/cms/files/files/000/000/886/original/ga-logo-gear.png" id="GA-logo"/>
        </a>
      </div>
    </div>
  {/* <!-- End footer --> */}
